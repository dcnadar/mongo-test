  ...
  try {
    ...
    const sectionModelData = {
      properties: [
        ...
        { dataType: 'DOUBLE', key: 'rating', name: 'Rating' },
        { dataType: 'STRING', key: 'reviewText', name: 'Review Text' },
        { dataType: 'STRING', key: 'reviewCount', name: 'Review Count' },
        {
          name: 'Enable Button',
          key: 'enableButton',
          dataType: 'BOOLEAN',
      ...
      name: 'ReactGrid CommonProductList4 Section',
      modelType: 'INNER',
      created: new Date(),
      modelStatus: 'ACTIVE',
    };
    ...
    const commonProductListModelData = {
      ...
      accountId: '5d6590b3af790ca2bcc707b7',
      name: 'ReactGrid CommonProductList4',
      modelType: 'INNER',
      created: new Date(),
      modelStatus: 'ACTIVE',
    };

    // Insert CommonProductList4 Model
    const commonProductListModelResult = await modelCollection.insertOne(
      commonProductListModelData
    );
    console.log(
      'CommonProductList4 model inserted with ID:',
    ...
    const sectionFormData = {
      ...
      gridTitle: 'ReactGrid CommonProductList4 Section',
    };
