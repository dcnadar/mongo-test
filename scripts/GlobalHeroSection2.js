...
async function run() {
    try {
      ...
      const globalHeroSection3ModelData = {
        ...
        name: 'ReactGrid GlobalHeroSection2',
        modelType: 'INNER',
        created: new Date(),
        modelStatus: 'ACTIVE',
      };
      ...
      const globalHeroSection3FormData = {
        ...
        rows: [
          {
            fields: [
              { index: 0, title: 'Title', id: 'title', type: 'text', span: 10, o: false, hint: 'Title of the Section' },
              { index: 1, title: 'Title Button Enable', id: 'titleButtonEnabled', type: 'bool', span: 6, o: false, hint: 'Enable Button in Title' },
              ...
              { index: 4, title: 'Heading', id: 'heading', type: 'text', span: 16, o: false, hint: 'Heading of the section' },
              { index: 5, title: 'Image', id: 'image', type: 'upload', span: 8, o: false, hint: 'Main Image of the section' },
              { index: 6, title: 'Description', id: 'description', type: 'textarea', span: 24, o: false, hint: 'Description of the section' },
              {
                "index": 7,
                "title": "Buttons",
                "id": "buttons",
        ...
        gridTitle: 'ReactGrid GlobalHeroSection2',
      };
