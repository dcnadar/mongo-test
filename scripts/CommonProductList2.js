...
async function run() {
  try {
    ...
    const sectionModelData = {
      ...
      name: 'ReactGrid CommonProductList2 Section',
      modelType: 'INNER',
      created: new Date(),
      modelStatus: 'ACTIVE',
    };
    ...
    const commonProductListModelData = {
      ...
      accountId: '5d6590b3af790ca2bcc707b7',
      name: 'ReactGrid CommonProductList2',
      modelType: 'INNER',
      created: new Date(),
      modelStatus: 'ACTIVE',
    };

    // Insert CommonProductList2 Model
    const commonProductListModelResult = await modelCollection.insertOne(
      commonProductListModelData
    );
    console.log(
      'CommonProductList2 model inserted with ID:',
    ...
    const sectionFormData = {
      ...
      gridTitle: 'ReactGrid CommonProductList2 Section',
    };
