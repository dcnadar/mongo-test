  ...
  try {
    ...
    const sectionModelData = {
      properties: [
        ...
        { dataType: 'STRING', key: 'thumb', name: 'Thumb' },
        {
          name: 'Enable Button',
          key: 'enableButton',
          dataType: 'BOOLEAN',
      ...
      name: 'ReactGrid GlobalImageWithTextCard Section',
      modelType: 'INNER',
      created: new Date(),
      modelStatus: 'ACTIVE',
    };
    ...
    const commonProductListModelData = {
      ...
      accountId: '5d6590b3af790ca2bcc707b7',
      name: 'ReactGrid GlobalImageWithTextCard',
      modelType: 'INNER',
      created: new Date(),
      modelStatus: 'ACTIVE',
    };

    // Insert GlobalImageWithTextCard Model
    const commonProductListModelResult = await modelCollection.insertOne(
      commonProductListModelData
    );
    console.log(
      'GlobalImageWithTextCard model inserted with ID:',
    ...
    const sectionFormData = {
      ...
      gridTitle: 'ReactGrid GlobalImageWithTextCard Section',
    };
